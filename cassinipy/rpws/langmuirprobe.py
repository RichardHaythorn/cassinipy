...
titan_flybydates = {'t17': [2006, 9, 7],
                    ...
                    't55': [2009, 5, 21], 't56': [2009, 6, 6], 't57': [2009, 6, 22], 't58': [2009, 7, 8],
                    't59': [2009, 7, 24],
                    't83': [2012, 5, 22]}
...
def read_LP_V1(flyby):
    ...
    with open(glob.glob(
            'data/' + moon + "/lp/RPWS_LP_T_" + str(titan_flybydates[flyby][0]) + "*" + flyby.upper() + "_V1.TAB")[0],
              'r') as csvfile:
...
def inst_RPWS_LP(LPdata, datetime):
    ...
    spacecraftpotential = np.interp(toTimestamp(datetime), lptimestamps,
